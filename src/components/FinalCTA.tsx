...
const FinalCTA = () => (
  <section id="contact" className="relative py-24 overflow-hidden bg-black flex flex-col items-center justify-center">
    ...
    <div className="relative z-10 w-full max-w-5xl mx-auto px-6">
      <div className="bg-[#12141A] rounded-[32px] border border-white/[0.05] p-10 md:p-20 flex flex-col md:flex-row items-center gap-12 relative overflow-hidden group">

        {/* Animated border sweep on container hover */}
        <div className="absolute inset-0 opacity-0 group-hover:opacity-100 transition-opacity duration-700 pointer-events-none">
          <div className="absolute inset-0 border-[1px] border-white/20 rounded-[32px] border-sweep" />
        </div>

        <div className="flex-1 text-center md:text-left">
          <span className="text-[11px] tracking-[0.3em] uppercase text-zinc-500 font-bold mb-6 block">
            Start Your Journey
          </span>
          <h2 className="text-[36px] md:text-[52px] font-bold tracking-tight text-white mb-6 leading-[1.1]">
        ...
        <div className="md:w-auto w-full flex flex-col items-center md:items-end gap-6 shrink-0">
          <motion.a
            ...
            whileTap={{ scale: 0.95 }}
            className="w-full md:w-auto px-10 py-5 bg-white text-black font-bold rounded-full hover:bg-zinc-100 transition-all text-[16px] shadow-[0_20px_40px_rgba(255,255,255,0.1)] relative z-20 overflow-hidden group/btn inline-block text-center"
          >
          ...
          <div className="flex flex-wrap items-center justify-center md:justify-end gap-x-4 gap-y-2 text-zinc-600 text-[12px] font-medium tracking-wide">
